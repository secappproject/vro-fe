...
const parseRawScan = (rawCode: string): ParsedScan => {
  ...
  if (len < 3) {
    ...
    return {
      ...
      quantity: null,
      format: null,
      error: "Format scan tidak lengkap (cth: MAT_IN_01)",
    };
  }
  ...
  if (movement === "IN") {
    if (len > 3)
      return {
        ...
        quantity: null,
        format: null,
        error: "Format IN tidak perlu Qty (cth: MAT_IN_01)",
      };
    return {
      raw: code,
      materialCode: materialCode,
  ...
  if (movement === "OUT") {
    ...
    return {
      ...
      quantity: null,
      format: null,
      error: "Format OUT salah (cth: MAT_OUT_01 atau MAT_OUT_01_10)",
    };
  }
    ...
    <DialogContent className="sm:max-w-2xl">
      <DialogHeader>
        ...
        <DialogDescription>
          ...
          [Material]_OUT_[Bin]_[Qty] (Bin 1 digit otomatis jadi 2 digit)
        </DialogDescription>
      </DialogHeader>
